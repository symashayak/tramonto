...
void uBSpline_InnerCore(int i,int j,double *rCore_left,double *rCore_right,double *epsCore);
double uBSpline_DERIV1D(double r,double x,double sigma,double eps,double rcut);
#define NONE       -1
#define NONE          -1
#define NONE        -1
#define NONE        -1
